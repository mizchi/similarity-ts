...
} from '../src/core/function_extractor.ts';
...
`;
    ...
    const comparison2 = compareFunctions(methodFunc, standaloneFunc, { ignoreThis: true });
...
`;
    ...
    console.log(`  Constructor vs initialize method: ${(compareFunctions(constructor, initMethod, { ignoreThis: true }).similarity * 100).toFixed(1)}%`);
