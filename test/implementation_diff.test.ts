...
function getTestCases(): TestCase[] {
  const fixtures = [
    ...
    // Refactoring
    { file1: "refactoring/class_to_function/user_service_class.ts", file2: "refactoring/class_to_function/user_service_functions.ts", category: "refactoring" },
    { file1: "refactoring/class_to_function/calculator_class.ts", file2: "refactoring/class_to_function/calculator_functions.ts", category: "refactoring" },
    
    // Duplication
    { file1: "duplication/structural/visitnode_pattern_1.ts", file2: "duplication/structural/visitnode_pattern_2.ts", category: "duplication" },
    { file1: "duplication/semantic/async_operations_1.ts", file2: "duplication/semantic/async_operations_2.ts", category: "duplication" },
    { file1: "duplication/exact/service_duplication_1.ts", file2: "duplication/exact/service_duplication_2.ts", category: "duplication" },
  ];
...
describe("TypeScript vs Rust Implementation Comparison", () => {
  ...
  describe.each(testCases)("$category: $file1 vs $file2", ({ file1, file2, category }) => {
    it("should have similar TSED values between implementations", () => {
      ...
      const hasKnownDifference = knownLargeDifferences.some(pattern => 
        file1.includes(pattern) || file2.includes(pattern)
      );
