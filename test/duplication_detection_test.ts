...
import { extractFunctions, compareFunctions, findDuplicateFunctions, type FunctionDefinition } from "../src/index.ts";
...
test("Copy-paste duplication detection", async () => {
  ...
  const duplicates = findDuplicateFunctions(errorFunctions, {
  ...
  const loopDuplicates = findDuplicateFunctions(loopFunctions, {
