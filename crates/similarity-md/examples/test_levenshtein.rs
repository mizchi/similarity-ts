...
fn main() {
    ...
    println!("文字レベル類似性: {:.4}", char_sim);
    println!("単語レベル類似性: {:.4}", word_sim);
    println!();
    ...
    println!("文字レベル類似性: {:.4}", char_sim2);
    println!("単語レベル類似性: {:.4}", word_sim2);
    println!();
    ...
    println!("文字レベル類似性: {:.4}", char_sim3);
    println!("単語レベル類似性: {:.4}", word_sim3);
    println!();
    ...
    println!("文字レベル類似性: {:.4}", char_sim4);
    println!("単語レベル類似性: {:.4}", word_sim4);
}
