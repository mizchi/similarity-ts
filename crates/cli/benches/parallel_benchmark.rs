...
use ts_similarity_cli::parallel::{
    check_cross_file_duplicates_parallel, check_within_file_duplicates_parallel, load_files_parallel,
};
use ts_similarity_cli::sequential::{
    check_cross_file_duplicates_sequential, check_within_file_duplicates_sequential, load_files_sequential,
};
...
fn benchmark_within_file_comparison(c: &mut Criterion) {
    ...
    for &num_files in &[10, 20, 50] {
        ...
        group.bench_with_input(
            ...
            |b, paths| {
                b.iter(|| {
                    let results = check_within_file_duplicates_sequential(
                        paths,
                        0.8,
                        &options,
                        false,
        ...
        group.bench_with_input(
            ...
            |b, paths| {
                b.iter(|| {
                    let results = check_within_file_duplicates_parallel(
                        paths,
                        0.8,
                        &options,
                        false,
...
fn benchmark_cross_file_comparison(c: &mut Criterion) {
    ...
    for &num_files in &[5, 10, 20] {
        ...
        group.bench_with_input(
            ...
            |b, data| {
                b.iter(|| {
                    let results = check_cross_file_duplicates_sequential(
                        data,
                        0.8,
                        &options,
                    );
        ...
        group.bench_with_input(
            ...
            |b, data| {
                b.iter(|| {
                    let results = check_cross_file_duplicates_parallel(
                        data,
                        0.8,
                        &options,
                        false,
