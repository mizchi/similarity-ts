...
function runAPTEDTests() {
  ...
  function test1_tsedFormula() {
    ...
    const tree1 = createTreeNode('root', [
  ...
  function test2_operationCosts() {
    ...
    console.log(`  Delete test: ${passDelete ? 'PASS' : 'FAIL'} (high cost: ${deleteHighCost} > low cost: ${deleteLowCost})`);
    console.log(`  Insert test: ${passInsert ? 'PASS' : 'FAIL'} (high cost: ${insertHighCost} > low cost: ${insertLowCost})`);
  ...
  function test3_edgeCases() {
    ...
    const tree1Copy = createTreeNode('root', [
      createTreeNode('a', [createTreeNode('b')]),
      createTreeNode('c')
    ]);
    ...
    const tree2 = createTreeNode('x', [
      createTreeNode('y', [createTreeNode('z')])
    ]);
    const tree3 = createTreeNode('p', [
      createTreeNode('q', [createTreeNode('r')])
    ]);
  ...
  function test4_mathematicalValidation() {
    ...
    const sim1_2 = calculateAPTEDSimilarityFromAST(ast1, ast2, { renameCost: 0.3 });
    const sim1_3 = calculateAPTEDSimilarityFromAST(ast1, ast3, { renameCost: 1 });
  ...
  function test6_parameterOptimization() {
    ...
    const rename1_0 = calculateAPTEDSimilarity(code1, code2, { renameCost: 1.0 });
    const rename0_8 = calculateAPTEDSimilarity(code1, code2, { renameCost: 0.8 });
    const rename0_5 = calculateAPTEDSimilarity(code1, code2, { renameCost: 0.5 });
    const rename0_3 = calculateAPTEDSimilarity(code1, code2, { renameCost: 0.3 });
  ...
  function test7_complexStructures() {
    ...
    const nestedSim = calculateAPTEDSimilarity(nestedCode1, nestedCode2, { renameCost: 0.3 });
